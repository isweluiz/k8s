...
backend kubernetes-backend
    ...
    option tcp-check
    balance roundrobin
    server kmaster1 192.168.0.45:6443 check fall 3 rise 2
    server kmaster2 192.168.0.122:6443 check fall 3 rise 2
```
...
```
kubeadm init --control-plane-endpoint="192.168.0.207:6443" --upload-certs --apiserver-advertise-address=192.168.0.122 --pod-network-cidr=192.168.0.0/24
```
